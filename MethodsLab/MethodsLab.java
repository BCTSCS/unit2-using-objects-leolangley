...
public class MethodsLab {
    public static void main(String[] args) {
        ...
        String fString = "Leo Langley";
        String nString = reverseString(fString);
        System.out.println("The initial string is: " + fString);
        System.out.println("The final string is: " + nString);
    }
    ...
    public static void valueVsNew() {
        Integer oldInt = Integer.valueOf(100); 
        @SuppressWarnings("removal") //I needed to use this or else it won't work.
        Integer newInt = new Integer(100); 
        
        System.out.println("If I use the .valueOf() method, it prints: " + oldInt);
        System.out.println("If I make a new variable, newInt: " + newInt);
        System.out.println("Now check to see if they are the same:");
        System.out.print(oldInt == newInt);
    }

    public static void parsing() {
        String p = "45.6";
        Double parsedNumber = Double.parseDouble(p);
        System.out.println("The parsed double from 45.6 is: " + parsedNumber);
    }

    public static String reverseString(String f) {
        String finalString = ""; 
        for (int i = f.length() - 1; i >= 0; i--) {
            finalString += f.substring(i, i + 1); 
        }
        return finalString;
    }
}
